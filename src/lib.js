...
function memberUpdate(e){
    ...
    if(typeof wwwroot == 'undefined'){
        var imgpath = "sites/all/modules/chat/images/online.png";
    }else{
        var imgpath = wwwroot+"sites/all/modules/chat/images/online.png"; //image folder path
    }
...
function displayChatHistory(){
    ...
    if (localStorage.getItem(sid) != null){
        var data = JSON.parse(localStorage.getItem(Drupal.settings.chat.sid));
